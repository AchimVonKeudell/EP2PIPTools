...
hitran_database_file = r"D:\Promotie\data\database\co2_database-He.sqlite"
spectrum_data = spectrum.Spectrum.from_wavenumber_array_params(500, 3800, 0.04)

molecule_simulator = GetSimulator.get_CO2_simulator(
