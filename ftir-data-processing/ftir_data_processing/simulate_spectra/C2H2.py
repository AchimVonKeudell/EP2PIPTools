...
hitran_database_file = r"D:\Promotie\data\database\c2h2_database.sqlite"
spectrum_data = spectrum.Spectrum.from_wavenumber_array_params(2500, 3500, 0.04)

molecule_simulator = GetSimulator.get_C2H2_simulator(
